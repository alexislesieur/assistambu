    ...
    <div className="min-h-screen bg-[#0A1E3D] flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[#8694A7] text-sm mt-1">Réinitialiser le mot de passe</p>
        </div>

        {success ? (
          <div className="bg-[#E6F2EC] border border-[#1D8348] rounded-lg p-4 text-[#1D8348] text-sm text-center">
